return {
    ...
    keys = {
        ...
        { "<leader>at", function() require("user-plugins.translate").split(true) end, mode = "v", desc = "翻译选中到侧栏" },
        { "<leader>aT", function() require("user-plugins.translate").replace(false) end, mode = "n", desc = "替换全文翻译" },
        { "<leader>aT", function() require("user-plugins.translate").replace(true) end, mode = "v", desc = "替换选中翻译" },
    },
}
